<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="ClienteAdmin.aspx.cs" Inherits="ProyectoGym.ClienteAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="provincia" DataValueField="provincia" Height="22px" Width="90px">
        </asp:DropDownList>
    ...
    <p>
        ...
        <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource2" DataTextField="canton" DataValueField="canton" Height="22px" Width="90px">
        </asp:DropDownList>
    ...
    <p>
        ...
        APELLIDO:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <strong>
        <asp:TextBox ID="txtApellido" runat="server" CssClass="auto-style6"></asp:TextBox>
        </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; DISTRITO:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource3" DataTextField="Distrito" DataValueField="Distrito" Height="22px" Width="90px">
        </asp:DropDownList>
...
&nbsp;&nbsp;&nbsp;&nbsp; </p>
    <p>
        ...
        TELÉFONO:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <strong>
        <asp:TextBox ID="txtTel" runat="server" CssClass="auto-style6"></asp:TextBox>
        </strong>
    </p>
    <p>
        &nbsp;&nbsp;
        EDAD:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <strong>
        <asp:TextBox ID="txtEdad" runat="server" CssClass="auto-style6"></asp:TextBox>
        </strong>
    </p>
    <p>
        &nbsp;</p>
    ...
    <p>
        ...
        <asp:Button ID="Button2" runat="server" class="button button3" Text="BORRAR" OnClick="Button2_Click" />&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; 
        <asp:Button ID="Button3" runat="server" class="button button3" Text="ACTUALIZAR" OnClick="Button3_Click" /></p>
    <p>
        &nbsp;&nbsp; </p>
    <p>
