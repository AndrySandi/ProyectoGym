<%@ Page Title="" Language="C#" MasterPageFile="~/Menu2.Master" AutoEventWireup="true" CodeBehind="FacturacionCliente.aspx.cs" Inherits="ProyectoGym.FacturaciónCliente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:Button class="button button2" runat="server" Text="FACTURAR" ID="btnFacturar" />
    <br />
    <br />
    <br />
    <br />
